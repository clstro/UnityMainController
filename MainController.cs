...
public class MainController : MonoBehaviour
{
    ...
    private void UpdateScenePreload()
    {
        ...
        //sceneLoadTask = Application.LoadLevelAdditiveAsync(nextSceneName); // Obsolete
    ...
    // clean up unused resources by unloading item
    ...
    // handle anything that need to happen immediately after loading
    ...
    // handle anything that need to happen immediately before running
